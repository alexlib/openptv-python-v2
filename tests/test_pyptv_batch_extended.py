...
from openptv.gui.pyptv_batch import run_batch, main, AttrDict
...
def test_run_batch(mock_experiment_dir, monkeypatch):
    ...
    # Apply the mock
    monkeypatch.setattr("openptv.gui.pyptv_batch.run_batch", mock_run_batch)
    ...
    try:
        # Test the function
        from openptv.gui.pyptv_batch import run_batch
