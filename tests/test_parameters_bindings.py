...
class Test_TrackingParams(unittest.TestCase):
    ...
    def setUp(self):
        self.input_tracking_par_file_name = "tests/testing_fodder/tracking_parameters/track.par"
...
class Test_VolumeParams(unittest.TestCase):
    def setUp(self):
        self.input_volume_par_file_name = "tests/testing_fodder/volume_parameters/volume.par"
        self.temp_output_directory = "tests/testing_fodder/volume_parameters/testing_output"
...
class Test_ControlParams(unittest.TestCase):
    def setUp(self):
        ...
        self.temp_output_directory = "tests/testing_fodder/control_parameters/testing_output"
