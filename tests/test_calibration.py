...
def plot_cal_points(pairs_list, save_path=None):
    '''
...
def plot_cal_err_histogram(pairs_list, save_path=None):
    '''
    plot a histogram of calibration errors in x, y, and z directions.
