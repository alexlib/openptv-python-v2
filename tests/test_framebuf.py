...
class TestFrame(unittest.TestCase):
    def test_read_frame(self):
        """reading a frame"""
        targ_files = ["tests/testing_fodder/frame/cam%d.".encode() % c for c in range(1, 5)]
        frm = Frame(4, corres_file_base="tests/testing_fodder/frame/rt_is".encode(),
            linkage_file_base="tests/testing_fodder/frame/ptv_is".encode(),
