...
# -*- coding: utf-8 -*-
"""
Test the parameter conversion between Python and Cython.
"""
...
from openptv.parameters.utils import bool_to_int
...
def test_tracking_params_to_cython():
    ...
    try:
        ...
        velocity_lims = [
            [py_params.dvxmin, py_params.dvxmax],
            [py_params.dvymin, py_params.dvymax],
            [py_params.dvzmin, py_params.dvzmax]
        ]
        
        # Create a Cython TrackingParams object directly
        cy_params = CythonTrackingParams(
            accel_lim=py_params.dacc,
            angle_lim=py_params.dangle,
            velocity_lims=velocity_lims,
            add_particle=bool_to_int(py_params.flagNewParticles)
        )
        print("Direct creation successful!")
        
        # Now try using the to_cython_object method
        cy_params2 = py_params.to_cython_object()
        print("to_cython_object method successful!")
