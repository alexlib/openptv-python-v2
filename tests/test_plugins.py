...
from openptv.gui.plugins.ext_sequence_denis import Sequence
from openptv.gui.plugins.ext_tracker_denis import Tracking
from openptv.gui.plugins.ext_sequence_contour import Sequence as Sequence_Contour

# Conditionally import rembg-dependent modules
import importlib.util
if importlib.util.find_spec("rembg") is not None:
    from openptv.gui.plugins.ext_sequence_rembg import Sequence as Sequence_Rembg
...
def mock_experiment_dir():
    ...
    for plugin_file in ["ext_sequence_denis.py", "ext_tracker_denis.py",
        ...
        src_path = Path("/home/user/Documents/repos/openptv-python-v2/openptv/gui/plugins") / plugin_file
        if src_path.exists():
