"""
Criteria parameters for OpenPTV.

This module provides the CriteriaParams class for handling criteria parameters.
"""
...
class CriteriaParams(Parameters):
    ...
    This class handles reading and writing criteria parameters to/from files.
    """
    ...
    def filename(self):
        """
        Get the filename for criteria parameters.
        
        Returns:
            str: The filename for criteria parameters.
        """
        return "criteria.par"
    
    def read(self):
        """
        Read criteria parameters from file.
        ...
        try:
            ...
            raise IOError(f"Error reading criteria parameters: {e}")
    
    def write(self):
        """
        Write criteria parameters to file.
        ...
        try:
            ...
            raise IOError(f"Error writing criteria parameters: {e}")
    
    def to_c_struct(self):
        """
        Convert criteria parameters to a dictionary suitable for creating a C struct.
        
        Returns:
            dict: A dictionary of criteria parameter values.
        """
        return {
            'X_lay': self.X_lay,
    ...
    def from_c_struct(cls, c_struct, path=None):
        """
        Create a CriteriaParams object from a C struct.
        
        Args:
            c_struct: A dictionary of criteria parameter values from a C struct.
            path: Path to the parameter directory.
        
        Returns:
            CriteriaParams: A new CriteriaParams object.
        """
        return cls(
