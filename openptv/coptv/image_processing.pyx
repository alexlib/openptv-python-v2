...
from openptv.coptv.parameters cimport ControlParams, control_par
import numpy as np
cimport numpy as np
from typing import Union

cdef extern from "../liboptv/include/image_processing.h":
    int prepare_image(unsigned char *img, unsigned char *img_hp, int filt_span,
                     int filter_hp, const char *filter_file, control_par *cpar)
